...
const API_CONFIG = {
  esl: {
    ...
    stage: { host: 'https://events-service-layer-stage-or2.adobe.io' },
    stage02: { host: 'https://events-service-layer-stage02-or2.adobe.io' },
  ...
  esp: {
    ...
    stage02: { host: 'https://events-service-platform-stage02-or2.adobe.io' },
