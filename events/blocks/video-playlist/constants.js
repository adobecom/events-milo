...
export const MOCK_API = {
    ...
    getSessions: async (playlistId = null, entityIds = null) => {
        ...
        const mockSessions = [
            ...
            { id: "3tmt6y3", search: { mpcVideoId: '3424767', videoId: 'yt_003', videoService: 'mpc', sessionId: 'sess_003', thumbnailUrl: 'https://images-tv.adobe.com/mpcv3/b8f920e0-0298-4d82-9ec3-c17d4c9ceda9/38f837a1-0b27-4319-9a7c-2429d88e3058/61f09647c0884bc3840da53bd2c2ffc0_1742533829-200x113.jpg', videoDuration: '00:51:53', sessionCode: 'S746', }, contentArea: { title: 'The Future of Adobe Workfront', description: 'Transforming project management.' }, overlayLink: 'https://business.adobe.com/summit/2025/sessions/s746.html', endDate: new Date(Date.now() + 86400000).toISOString(), startDate: new Date(Date.now() - 86400000).toISOString() },
