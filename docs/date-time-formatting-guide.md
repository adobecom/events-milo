...
### With Year (Short)
```
Template: {LLL} {dd}, {YY} | {timeRange} {timeZone}
Output: Oct 20, 25 | 13:00 - 14:45 PDT
```
...
### Annual Events
```
Template: {LLL} {dd}, {YYYY} | {timeRange} {timeZone}
Usage: Events where the year is important to display
Example: Oct 20, 2025 | 2:00 PM - 3:00 PM PDT
```
