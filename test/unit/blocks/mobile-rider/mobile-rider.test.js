...
describe('Mobile Rider Module', () => {
  let createTagStub, getConfigStub, mockFetch, mockLana;
  ...
  describe('MobileRider class methods', () => {
    ...
    describe('onDrawerClick', () => {
      ...
      it('should handle non-live stream click', async () => {
        ...
        expect(riderInstance.injectPlayer.called).to.be.false;
      });
    ...
    describe('setStatus', () => {
      it('should set status in store when status changes', () => {
        ...
        expect(riderInstance.store.set.calledWith('main-video', true)).to.be.true;
      });
      ...
      it('should handle missing mainID', () => {
  ...
  describe('Concurrent Live Stream Management', () => {
    ...
    it('should maintain mainID reference and use it for status checks', async () => {
      ...
      concurrentInstance.getMediaStatus = sinon.stub().resolves({ 
        active: ['video1'] 
      });
    ...
    it('should update store when status changes', async () => {
      ...
      concurrentInstance.getMediaStatus = sinon.stub().resolves({ 
        active: [] // Status changed to false
      });
